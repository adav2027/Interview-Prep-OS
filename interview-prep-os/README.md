...
| Component | Purpose |
|-----------|---------|
| **Prep skill** | A `/prep-interview` workflow for Claude / Cursor that runs mock interviews, gives real feedback, and builds prep docs |
...
├── skill/prep-interview/           # The prep skill (copy into .claude/skills/ to activate)
...
| `skill/prep-interview/SKILL.md` | Optionally — tune the interviewer's persona and toughness |
